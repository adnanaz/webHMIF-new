    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="../scss/assets/img/logo-fbb.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../scss/assets/img/dummy-profile.jpg" width="160px" height="160px"
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./berita.admin.html" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Isi Berita</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./artikel.admin.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Isi Artikel</p>
                                    </a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('adminartikel.update', $artikel) }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="judul">Judul</label>
                                        <input type="text" class="form-control" id="judul" name="judul" aria-describedby="judulhelp" value="{{ $artikel->judul }}">
                                        <small id="judulhelp" class="form-text text-muted">We'll never share your email
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2019 <a href="http://adminlte.io">AdminLTE.io edited on
                    OneCode.id</a>.</strong>
            All rights reserved.
